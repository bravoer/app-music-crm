...
curl -g --data-urlencode query@backup.sparql http://$(docker inspect --format='{{ .NetworkSettings.Networks.musiccrm_default.IPAddress }}' musiccrm_db_1):8890/sparql > ${FILENAME}
